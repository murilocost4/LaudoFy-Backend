...
exports.buscarTiposExame = async (req, res) => {
  try {
    ...
    console.log('Buscando tipos de exame para especialidade:', especialidadeId);
    ...
    console.log('Especialidade encontrada:', especialidade.nome);
    ...
    console.log(`Encontrados ${tiposExame.length} tipos de exame para a especialidade ${especialidade.nome}`);
...
exports.listarEspecialidadesAtivas = async (req, res) => {
  try {
    ...
    console.error('Erro ao listar especialidades ativas:', err);
...
exports.obterEstatisticasEspecialidades = async (req, res) => {
  try {
    ...
    console.error('Erro ao obter estatísticas de especialidades:', err);
