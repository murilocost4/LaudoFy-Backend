...
exports.listarTiposExame = async (req, res) => {
  try {
    ...
    console.error('Erro ao listar tipos de exame:', err);
...
exports.criarTipoExame = async (req, res) => {
  ...
  try {
    ...
    await session.abortTransaction();
    console.error('Erro ao criar tipo de exame:', err);
...
exports.atualizarTipoExame = async (req, res) => {
  ...
  try {
    ...
    await session.abortTransaction();
    console.error('Erro ao atualizar tipo de exame:', err);
...
exports.deletarTipoExame = async (req, res) => {
  ...
  try {
    ...
    await session.abortTransaction();
    console.error('Erro ao deletar tipo de exame:', err);
...
exports.obterTipoExamePorId = async (req, res) => {
  try {
    ...
    console.error('Erro ao buscar tipo de exame:', err);
    res.status(500).json({ 
...
exports.listarTiposUrgentes = async (req, res) => {
  try {
    ...
    console.error('Erro ao listar tipos urgentes:', err);
...
exports.alterarStatusTipoExame = async (req, res) => {
  try {
    ...
    console.error('Erro ao alterar status do tipo de exame:', err);
    res.status(500).json({ 
...
exports.obterEstatisticasTiposExame = async (req, res) => {
  try {
    ...
    console.error('Erro ao obter estatísticas dos tipos de exame:', err);
    res.status(500).json({ 
