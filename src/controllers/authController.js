...
exports.login = async (req, res) => {
    try {
        ...
        try {
            ...
            console.error('Erro ao criar log de auditoria do login:', auditError);
        }
...
exports.refreshToken = async (req, res) => {
    try {
        ...
        try {
            ...
            console.error('Erro ao criar log de auditoria do refresh token:', auditError);
        }
...
exports.resetarSenha = async (req, res) => {
    try {
        ...
        try {
            ...
            console.error('Erro ao criar log de auditoria do reset de senha:', auditError);
        }
